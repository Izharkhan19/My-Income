...
import { deleteIncomeById, getIncomesData, saveIncomeData } from '../../Services/IncomeServices';
  ...
  return (
    <Container fluid >
      <div className="text-center">
        <h2>Total Income: <span style={{ color: 'green' }}>${TotalIncome}</span>  </h2>
      </div>
            ...
            incomeRes?.map((itm, idx) => (
              <Row key={idx} className='dash-text-color mapped-card-design' >
                ...
                <Col xs={2}
                  ...
                  <div onClick={() => handleDeleteIncomeById(itm._id)}>
